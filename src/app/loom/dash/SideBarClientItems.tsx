		...
		<Link
			className={
				...
				(currPath == "/loom/dash" && path == "/")
					? "flex items-center gap-3 rounded-lg bg-gray-100 px-3 py-2 text-gray-900  transition-all hover:text-gray-900 dark:bg-muted dark:text-gray-50 dark:hover:text-gray-50"
